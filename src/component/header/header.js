    ...
    <header className="header">
      <div className="container">
        <div className={headerContainer}>
          <button onClick={toggleMenu} className={headerMenuClass}></button>
          ...
          <div className={headerRightElementClass}>
            <nav className="header__nav">
              <div className="header__navLeft">
                <Link to={"/about"} className="header__navLink">про фонд</Link>
                <Link to={"/news"} className="header__navLink">новини</Link>
                <Link to={"/reports"} className="header__navLink">звіти</Link>
              ...
              <div className="header__navRight">
                ...
                <Link to={'/quickDonate'} className="header__button"><RedButton text="Швидкий донат" /></Link>
